!(function (o, r, p) {
    ...
    var c = p("html"),
        ...
        d = "#FF5B5C";
    if (
        (p(o).on("scroll", function () {
            20 < p(o).scrollTop()
                ? p("body").addClass("page-scrolled navbar-scrolled")
                : p("body").removeClass("page-scrolled navbar-scrolled");
        }),
        p(o).on("load", function () {
            ...
            u.hasClass("menu-collapsed") && (a = !0),
                ...
                p.each(p(".menu-livicon"), function (e) {
                    ...
                    a.addLiviconEvo({
                        ...
                        afterAdd: function () {
                            e ===
                                p(".main-menu-content .menu-livicon").length -
                                    1 &&
                                p(".main-menu-content .nav-item a").on(
                                    "mouseenter",
                                    function () {
                                        p(".main-menu-content .menu-livicon")
                                            .length &&
                                            (p(
                                                ".main-menu-content .menu-livicon"
                                            ).stopLiviconEvo(),
                                            p(this)
                                                .find(".menu-livicon")
                                                .playLiviconEvo());
            ...
            !1 === p.app.nav.initialized && p.app.nav.init({ speed: 300 }),
                ...
                p('a[data-action="expand"]').on("click", function (e) {
                    e.preventDefault(),
                        ...
                        p(this).closest(".card").toggleClass("card-fullscreen");
                }),
                ...
                p('a[data-action="reload"]').on("click", function () {
                    ...
                    if (u.hasClass("dark-layout")) var a = "#10163a";
                    else a = "#fff";
                    e.block({
                        message:
                            '<div class="bx bx-sync icon-spin font-medium-2 text-primary"></div>',
                        timeout: 2e3,
                        overlayCSS: { backgroundColor: a, cursor: "wait" },
                ...
                p('.card .heading-elements a[data-action="collapse"]').on(
                    "click",
                    function () {
                        var e,
                            a = p(this).closest(".card");
                        0 < parseInt(a[0].style.height, 10)
                            ? ((e = a.css("height")),
                              a.css("height", "").attr("data-height", e))
                            : a.data("height") &&
                              ((e = a.data("height")),
                              a.css("height", e).attr("data-height", ""));
                    }
                ),
                p(".main-menu-content")
                    .find("li.active")
                ...
                p(".nav-item.active .menu-livicon").length &&
                    e(p(".nav-item.active .menu-livicon")),
                p(".main-menu-content li.sidebar-group-active .menu-livicon")
                    .length &&
                    e(
                        p(
            ...
            if (
                (t.css("height", s),
                u.hasClass("boxed-layout") &&
                    u.hasClass("vertical-overlay-menu"))
            ) {
                var o = p(".main-menu").width(),
                    i = p(".app-content").position().left - o;
                u.hasClass("menu-flipped")
                    ? p(".main-menu").css("right", i + "px")
                    : p(".main-menu").css("left", i + "px");
            }
            p(".custom-file input").change(function (e) {
                        ...
                        p(".char-count").html(e.value.length),
                            e.value.length > n
                                ? (p(".counter-value").css(
                                  ...
                                  p(".char-textarea").css("color", d),
                                  p(".char-textarea").addClass("max-limit"))
                                : (p(".counter-value").css(
                                      "background-color",
                                      "#5A8DEE"
                                  ),
                                  p(".char-textarea").css("color", "#304156"),
                                  p(".char-textarea").removeClass("max-limit"));
                    })(this, e),
                        p(this).addClass("active");
                }),
                p(".content-overlay").on("click", function () {
                    p(".search-list").removeClass("show"),
                        p(".app-content").removeClass("show-overlay"),
                        p(".bookmark-wrapper .bookmark-input").removeClass(
                            "show"
                        );
                });
            ...
            0 < l.length &&
                l[0].addEventListener("ps-scroll-y", function () {
                    0 < p(this).find(".ps__thumb-y").position().top
                        ? p(".shadow-bottom").css("display", "block")
                        : p(".shadow-bottom").css("display", "none");
                });
        }),
        ...
        if (0 < p(e).length)
            new Hammer(e).on("panright", function (e) {
                if (u.hasClass("vertical-overlay-menu"))
                    return p.app.menu.open(), !1;
            });
        setTimeout(function () {
            var e,
    ...
    if (
        (p(r).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
            return (
                ...
                0 < p("#collapsed-sidebar").length &&
                    setTimeout(function () {
                        u.hasClass("menu-expanded") || u.hasClass("menu-open")
                            ? p("#collapsed-sidebar").prop("checked", !1)
                            : p("#collapsed-sidebar").prop("checked", !0);
                    }, 1e3),
                p(
            ...
            p(r).on(screenfull.raw.fullscreenchange, function () {
                screenfull.isFullscreen
                    ? (p(".nav-link-expand")
                      ...
                      p("html").addClass("full-screen"))
                    : (p(".nav-link-expand")
                          .find("i")
                          .toggleClass("bx-fullscreen bx-exit-fullscreen"),
                      p("html").removeClass("full-screen"));
            }),
        p(r).ready(function () {
            p(".step-icon").each(function () {
                var e = p(this);
                0 < e.siblings("span.step").length &&
                    (e.siblings("span.step").empty(),
                    p(this).appendTo(p(this).siblings("span.step")));
            });
        }),
        p(o).resize(function () {
        ...
        "laravel" === u.attr("data-framework"))
    ) {
        var n = p("html")[0].lang;
        if (null !== n) {
            var t = p(".dropdown-language")
                    .find("a[data-language=" + n + "]")
                    .text(),
                s = p(".dropdown-language")
                    .find("a[data-language=" + n + "] .flag-icon")
                    .attr("class");
            p("#dropdown-flag .selected-language").text(t),
                p("#dropdown-flag .flag-icon").removeClass().addClass(s);
        }
    } else
        i18next
            .use(o.i18nextXHRBackend)
            .init(
                {
                    debug: !1,
                    fallbackLng: "en",
                    backend: {
                        loadPath:
                            "../../../admin-assets/data/locales/{{lng}}.json",
                    },
                    returnObjects: !0,
                },
                function (e, a) {
                    jqueryI18next.init(i18next, p);
                }
            ),
            p(".dropdown-language .dropdown-item").on("click", function () {
                ...
                p("#dropdown-flag .selected-language").text(a),
                    p("#dropdown-flag .flag-icon").removeClass().addClass(n);
                var t = e.data("language");
                i18next.changeLanguage(t, function (e, a) {
                    p(".main-menu, .navbar-horizontal").localize();
                });
            });
    ...
    p(".bookmark-wrapper .bookmark-star").on("click", function (e) {
        ...
        p(".nav-link-search").on("click", function () {
            p(this);
            var e = p(this).parent(".nav-search").find(".search-input");
            e.val(""),
                e.addClass("open"),
        ...
        p(".search-input-close i").on("click", function () {
            ...
            e.hasClass("open") &&
                ...
                p(".app-content").hasClass("show-overlay") &&
                    p(".app-content").removeClass("show-overlay"));
        }),
        ...
        p(".search-input .input").on("keyup", function (e) {
            if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
                27 == e.keyCode &&
                    ...
                    p(".search-list").hasClass("show") &&
                        (p(this).removeClass("show"),
                        p(".search-input").removeClass("show")));
                var s = p(this).val().toLowerCase(),
                    o = "",
                    i = !1;
                if (
                    (p("ul.search-list li").remove(),
                    p(this).parent().hasClass("bookmark-input") && (i = !0),
                    "" != s)
                ) {
                    p(".app-content").addClass("show-overlay"),
                        p(".bookmark-input").focus()
                            ? p(".bookmark-input .search-list").addClass("show")
                            : (p(".search-input .search-list").addClass("show"),
                              p(".bookmark-input .search-list").removeClass(
                                  "show"
                              )),
                        !1 === i &&
                            (p(".search-input .search-list").addClass("show"),
                        ...
                        function (e) {
                            for (var a = 0; a < e.listItems.length; a++) {
                                if (!0 === i) {
                                    ...
                                    for (
                                        var n = p(
                                                "ul.nav.navbar-nav.bookmark-icons li"
                                            ),
                                            t = 0;
                                        t < n.length;
                                        t++
        ...
        p(r).on("mouseenter", ".search-list li", function (e) {
            p(this).siblings().removeClass("current_item"),
                p(this).addClass("current_item");
        }),
        ...
        p("html").on("click", function (e) {
            p(e.target).hasClass("bookmark-icon") ||
                (p(".bookmark-input .search-list").hasClass("show") &&
                    p(".bookmark-input .search-list").removeClass("show"),
                p(".bookmark-input").hasClass("show") &&
                    p(".bookmark-input").removeClass("show"));
        }),
        p(r).on(
            "click",
            ...
            function (e) {
                if ((e.stopPropagation(), p(this).hasClass("warning"))) {
                    ...
                    for (
                        var a = p("ul.nav.navbar-nav.bookmark-icons li"), n = 0;
                        n < a.length;
                        n++
                    )
                        a[n].firstChild.dataset.originalTitle ==
                            p(this).parent()[0].innerText && a[n].remove();
                    e.preventDefault();
                } else {
        ...
        p(o).on("keydown", function (e) {
            ...
            if (
                (40 === e.keyCode
                    ? ((a = t.next()),
                      t.removeClass("current_item"),
                      (t = a.addClass("current_item")))
                    : 38 === e.keyCode &&
                      ((n = t.prev()),
                      t.removeClass("current_item"),
                      (t = n.addClass("current_item"))),
                13 === e.keyCode &&
                    0 < p(".search-list li.current_item").length)
            ) {
                var s = p(".search-list li.current_item a");
                (o.location = s.attr("href")), p(s).trigger("click");
            }
        }),
        p(".header-navbar .dropdown-notification label").on(
            "click",
            function (e) {
                e.stopPropagation();
            }
        ...
        jQuery.validator.setDefaults({
            ...
            errorPlacement: function (e, a) {
                ...
                "checkbox" === a.attr("type")
                    ...
                    : a.hasClass("custom-control-input")
                    ? e.insertAfter(a.parent().siblings(":last"))
                    : e.insertAfter(a),
                    a.parent().hasClass("input-group") &&
