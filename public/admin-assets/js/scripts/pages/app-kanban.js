...
$(function () {
            ...
            item: [
                {
                    ...
                    attachment: 3,
                    users: [
                        "../../../admin-assets/images/portrait/small/avatar-s-11.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-12.jpg",
                    ],
                },
                {
                    id: "12",
                    ...
                    border: "info",
                    image: "../../../admin-assets/images/banner/banner-21.jpg",
                    dueDate: "Feb 10",
                },
                {
                    id: "13",
                    ...
                    attachment: 4,
                    users: [
                        "../../../admin-assets/images/portrait/small/avatar-s-1.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-18.jpg",
                    ],
                },
                {
                    id: "14",
                    ...
                    attachment: 2,
                    users: [
                        "../../../admin-assets/images/portrait/small/avatar-s-26.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-16.jpg",
                    ],
                },
                {
                    id: "15",
        ...
        },
        {
            ...
            item: [
                ...
                },
                {
                    ...
                    comment: 8,
                    users: [
                        "../../../admin-assets/images/portrait/small/avatar-s-24.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-14.jpg",
                    ],
                },
                {
                    id: "23",
            ...
            item: [
                {
                    ...
                    comment: 10,
                    users: [
                        "../../../admin-assets/images/portrait/small/avatar-s-20.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-22.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-13.jpg",
                    ],
                },
                {
                    id: "32",
                ...
                },
                {
                    ...
                    users: [
                        "../../../admin-assets/images/portrait/small/avatar-s-1.jpg",
                        "../../../admin-assets/images/portrait/small/avatar-s-2.jpg",
                    ],
                },
            ],
        },
    ...
    var KanbanExample = new jKanban({
        ...
        click: function (el) {
            ...
            // set edit title
            $(".edit-kanban-item .edit-kanban-item-title").val(
                kanban_item_title
            );
        },
    ...
    for (kanban_data in kanban_board_data) {
        ...
        for (kanban_item in kanban_board_data[kanban_data].item) {
            var board_item_details =
                kanban_board_data[kanban_data].item[kanban_item]; // set item details
            ...
            if (typeof $(board_item_el).attr("data-users") !== "undefined") {
                for (kanban_users in kanban_board_data[kanban_data].item[
                    kanban_item
                ].users) {
                    board_item_users +=
                        '<li class="avatar pull-up my-0">' +
                        '<img class="media-object rounded-circle" src=" ' +
                        kanban_board_data[kanban_data].item[kanban_item].users[
                            kanban_users
                        ] +
            ...
            if (
                typeof $(board_item_el).attr("data-attachment") !== "undefined"
            ) {
                board_item_attachment =
            ...
            if (
                typeof $(board_item_el).attr("data-badgeContent") !==
                "undefined"
            ) {
                board_item_badge =
                    '<div class="kanban-badge">' +
                    '<div class="badge-circle badge-circle-sm badge-circle-light-' +
                    kanban_board_data[kanban_data].item[kanban_item]
                        .badgeColor +
    ...
    if (
        $(".kanban-sidebar .edit-kanban-item .kanban-edit-content").length > 0
    ) {
    ...
    $("select").change(function () {
        $(this)
            ...
            .addClass(
                $(":selected", this).attr("class") + " form-control text-white"
            );
    });
});
