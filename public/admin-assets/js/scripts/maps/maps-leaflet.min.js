...
function onLocationFound(e) {
    ...
    L.marker(e.latlng)
        .addTo(userMap)
        .bindPopup("You are somewhere around " + t + " meters from this point")
        .openPopup(),
        L.circle(e.latlng, t).addTo(userMap);
}
function getColor(e) {
    return 1e3 < e
        ? "#800026"
...
$(function () {
    var e = $("#basic-map"),
        t = $("#circle-polygon-map"),
        o = $("#draggable-marker-map"),
        r = $("#user-location-map"),
        a = $("#custom-icons-map"),
        i = $("#geojson-map"),
        p = $("#layer-control-map"),
    ...
    if (e.length) {
        var s = L.map("basic-map").setView([42.35, -71.08], 10);
    ...
    if (t.length) {
        var y = L.map("circle-polygon-map").setView([51.5, -0.09], 12);
        L.marker([51.5, -0.09]).addTo(y),
    ...
    if (o.length) {
        var d = L.map("draggable-marker-map").setView([48.817152, 2.455], 12);
        L.marker([48.817152, 2.455], { draggable: "true" })
            .addTo(d)
    ...
    if (r.length) {
        var m = L.map("user-location-map").setView([42.35, -71.08], 10);
        m.locate({ setView: !0, maxZoom: 16 }),
    ...
    if (a.length) {
        var g = L.map("custom-icons-map").setView([51.5, -0.09], 10),
            l = L.icon({
                iconUrl: "../../../admin-assets/images/maps/leaf-green.png",
                shadowUrl: "../../../admin-assets/images/maps/leaf-shadow.png",
                iconSize: [38, 95],
                shadowSize: [50, 64],
                iconAnchor: [22, 94],
                shadowAnchor: [4, 62],
            ...
            c = L.icon({
                iconUrl: "../../../admin-assets/images/maps/leaf-red.png",
                shadowUrl: "../../../admin-assets/images/maps/leaf-shadow.png",
                iconSize: [38, 95],
                shadowSize: [50, 64],
                iconAnchor: [22, 94],
            ...
            u = L.icon({
                iconUrl: "../../../admin-assets/images/maps/leaf-orange.png",
                shadowUrl: "../../../admin-assets/images/maps/leaf-shadow.png",
                iconSize: [38, 95],
                shadowSize: [50, 64],
                iconAnchor: [22, 94],
        ...
        L.marker([51.5, -0.09], { icon: c }).addTo(g),
            L.marker([51.4, -0.51], { icon: l }).addTo(g),
            L.marker([51.49, -0.45], { icon: u }).addTo(g),
            L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
                attribution:
                    'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
                maxZoom: 18,
    ...
    if (i.length) {
        var h = L.map("geojson-map").setView([44.2669, -72.576], 3);
        L.geoJson(n).addTo(h),
            L.geoJson(n, { style: style }).addTo(h),
            L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
                attribution:
                    'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
                maxZoom: 18,
    ...
    if (p.length) {
        var F = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO."),
            P = L.marker([39.74, -104.99]).bindPopup("This is Denver, CO."),
            w = L.marker([39.73, -104.8]).bindPopup("This is Aurora, CO."),
            f = L.marker([39.77, -105.23]).bindPopup("This is Golden, CO."),
            M = L.layerGroup([F, P, w, f]),
            b = L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
                attribution:
                    'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
                maxZoom: 18,
            }),
            ...
            x = L.map("layer-control-map", {
                center: [39.73, -104.99],
                zoom: 10,
                layers: [b, M],
            }),
            k = { Street: b, Watercolor: T },
            C = { Cities: M };
        L.control.layers(k, C).addTo(x),
