...
if (typeof jQuery === "undefined") {
    window.alert(
        "LivIcons Evolution Script requires jQuery (https://jquery.com)!"
    );
    throw new Error(
        "LivIcons Evolution Script requires jQuery (https://jquery.com)!"
    );
...
function LivIconsEvoDefaults() {
    ...
    var defaultOptions = {
        pathToFolder: "../../../admin-assets/fonts/LivIconsEvo/svg/", //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
        ...
        brightness: 0.1, // brightness change when 'lighter' or 'darker' (10% by default)
    ...
    if (defaultOptions.pathToFolder === "/EDIT THIS OPTION!/") {
        window.alert(
            'LivIcons Evolution: Please edit "pathToFolder" option in the "LivIconsEvo.defaults.js" file!'
        );
        throw new Error(
            'LivIcons Evolution: Please edit "pathToFolder" option in the "LivIconsEvo.defaults.js" file!'
        );
