                        ...
                        <div class="card bg-authentication mb-0">
                            ...
                            <div class="divider">
                                        ...
                                        email</small>
                                            ...
                                            <form method="POST" action="{{route('login') }}">
                                                ...
                                                <div class="form-group mb-50">
                                                    <label class="text-bold-600" for="email">Emaill address</label>
                                            ...
                                            class="card-link"><small>Forgot Password?</small></a></div> -->
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-success glow w-100 position-relative">Login<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                            </form>

                                            <!-- <hr><div class="text-center"><small class="mr-25">Don't have an account?</small><a 
                                ...
                                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                    <img class="img-fluid" src="{{ asset('admin-assets/images/pages/cls_logo.png') }}" alt="branding logo">
                                </div>
                            </div>
                        </div>
                    </div>
